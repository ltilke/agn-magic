...
class DataWidget(QWidget):
    ...
    #     self.setLayout(outer_layout)
    #     outer_layout.addWidget(QLabel("Data Sub-Widget"))
    #
    #     file_button = QPushButton("Select Files")
    #     outer_layout.addWidget(file_button)
    #     file_button.clicked.connect(self.get_files())
    #
    # @staticmethod
    # def get_files():
    #     file_dialog = QFileDialog()
    #     file_dialog.setFileMode(QFileDialog.AnyFile)
    #     file_dialog.setFilter("Data Files (*.fits *.fit *.fts *.lc)")
    #     files = []
    #     if file_dialog.exec():
